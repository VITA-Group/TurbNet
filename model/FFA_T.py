...
class FFANet(nn.Module):
    def __init__(self, gps, blocks, conv=default_conv):
        ...
        self.palayer2 = PALayer2(3)
        
        self.conv_J_1 = nn.Conv2d(64, 64, 3, 1, 1, bias=False)
        self.conv_J_2 = nn.Conv2d(64, 3, 3, 1, 1, bias=False)
        
        self.conv_T_1 = nn.Conv2d(64, 3, 3, 1, 1, bias=False)
        self.conv_T_2 = nn.Conv2d(64, 3, 3, 1, 1, bias=False)
        
        self.ANet = translation2D(3)
    ...
    def forward(self, x1, x2=0, Val=False):
        ...
        out_T = self.palayer2(out_T)
        
        # out_eps = self.ANet(x1)
        
        # print(out_eps.shape, out_J.shape)
        
        out_I = out_T * out_J

        #out = original_output, out_J = turbulance_free image, out_T = turbulance model, out_I = reconstructed_input

        return out, out_J, out_T, out_I
        
def get_model(gps, blocks):
